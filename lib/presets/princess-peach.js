...
export default {
  theme: {
    ui: `@text-color: rgba(104, 54, 55, 1);
@text-value: -10;
...
@button-color: rgba(255, 126, 121, 1);
@button-value: 0;
...
@settingsPage-border: false;`,
    syntax: `@editor-backgroundcolor: rgba(253, 222, 218, 1);
...
@selectedline-backgroundguttercolor: rgba(255, 100, 92, 1);
@cursor-style: pacman;
@cursor-color: rgba(255, 213, 0, 1);
@cursor-shadow: rgba(51, 51, 51, 1);
@indentguide-linecolor: rgba(230, 144, 134, 1);
@indentguide-value: 0;
...
@string-color: rgba(247, 100, 126, 1);
