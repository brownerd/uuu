export princessPeachUI = `@text-color: rgba(255, 126, 121, 1);
@text-value: -10;
...
export princessPeachSyntax = `@editor-backgroundcolor: rgba(253, 222, 218, 1);
...
@bracketmatcher-background: rgba(0, 243, 178, 1);
@comment-color: rgba(255, 193, 181, 1);
