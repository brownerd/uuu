...
export default {
  theme: {
    ui: `@text-color: rgba(153, 75, 99, 1);
@text-value: 0;
...
@git-infoColor: rgba(10, 153, 122, 1);
...
@settingsPage-border: false;`,
    syntax: `@editor-backgroundcolor: rgba(112, 46, 64, 1);
@editor-color: rgba(27, 153, 123, 1);
@gutter-backgroundcolor: rgba(113, 45, 64, 1);
@gutter-color: rgba(178, 96, 124, 1);
@gutter-value: 30;
@gutter-punk: hellyeah;
@selectedline-backgroundcolor: rgba(97, 38, 54, 1);
@selectedline-backgroundguttercolor: rgba(0, 154, 121, 1);
@cursor-style: pacman;
