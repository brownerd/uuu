...
export default {
  theme: {
    ui: `@text-color: rgba(254, 47, 145, 1);
@text-value: 0;
...
@terminal-backgroundColor: rgba(97, 36, 117, 1);
@terminal-backgroundValue: -25;
@terminal-textColor: rgba(255, 255, 255, 1);
@terminal-cursorColor: rgba(235, 72, 143, 1);`,
    syntax: `@editor-backgroundcolor: rgba(240, 251, 0, 1);
@editor-color: rgba(106, 24, 122, 1);
@gutter-color: rgba(106, 24, 122, 1);
@gutter-value: 30;
@gutter-punk: hellyeah;
@selectedline-backgroundcolor: rgba(0, 250, 93, 1);
@selectedline-backgroundguttercolor: rgba(255, 47, 145, 1);
@cursor-style: pacman;
...
@string-color: rgba(31, 160, 152, 1);
