...
export default {
  theme: {
    ui: `@text-color: rgba(95, 91, 137, 1);
@text-value: 0;
...
@button-color: rgba(124, 159, 255, 1);
@button-value: 0;
...
@settingsPage-border: false;`,
    syntax: `@editor-backgroundcolor: rgba(51, 45, 90, 1);
@editor-color: rgba(123, 156, 255, 1);
@gutter-backgroundcolor: rgba(51, 43, 91, 1);
@gutter-color: rgba(102, 91, 141, 1);
@gutter-value: 30;
@gutter-punk: hellyeah;
@selectedline-backgroundcolor: rgba(40, 37, 74, 1);
@selectedline-backgroundguttercolor: rgba(124, 159, 255, 1);
@cursor-style: pacman;
@cursor-color: rgba(255, 213, 0, 1);
@cursor-shadow: rgba(51, 51, 51, 1);
@indentguide-linecolor: rgba(81, 70, 123, 1);
@indentguide-value: 0;
@folded-codecolor: rgba(255, 47, 146, 1);
@bracketmatcher-backgroundcolor: rgba(255, 47, 146, 1);
@comment-color: rgba(81, 71, 122, 1);
@comment-fontstyle: normal;
@comment-value: 0;
@selector-color: rgba(253, 72, 123, 1);
@selector-fontstyle: normal;
@pseudo-color: rgba(255, 151, 0, 1);
@pseudo-fontstyle: normal;
@pseudo-weight: normal;
@selector-weight: normal;
@propertyname-color: rgba(133, 170, 255, 1);
