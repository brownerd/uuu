...
@text-value: 0;
@heading-color: rgba(145, 145, 145, 1);
@heading-value: 0;
@background-color: rgba(255, 255, 255, 1);
@background-value: 0;
@background-navvalue: -30;
@button-color: rgba(169, 169, 169, 1);
@button-value: 0;
...
@terminal-backgroundColor: rgba(217, 217, 217, 1);
@terminal-backgroundValue: -50;
@terminal-textColor: rgba(255, 255, 255, 1);
@terminal-cursorColor: rgba(66, 66, 66, 1);`,
...
@selectedline-backgroundcolor: rgba(235, 235, 235, 1);
...
@comment-color: rgba(214, 214, 214, 1);
...
@regex-weight: normal;
@control-color: rgba(169, 169, 169, 1);
