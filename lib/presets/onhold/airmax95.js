...
@terminal-backgroundColor: rgba(131, 131, 131, 1);
@terminal-backgroundValue: -50;
@terminal-textColor: rgba(255, 255, 255, 1);
@terminal-cursorColor: rgba(241, 249, 89, 1);`,
    syntax: `@editor-backgroundcolor: rgba(169, 169, 169, 1);
@editor-color: rgba(51, 51, 51, 1);
@gutter-color: rgba(51, 51, 51, 1);
@gutter-value: 0;
@gutter-punk: hellyeah;
@selectedline-backgroundcolor: rgba(121, 121, 121, 1);
@selectedline-backgroundguttercolor: rgba(239, 251, 0, 1);
@cursor-style: pacman;
