...
@findAndReplace-borderHighLightColorCurrent: rgba(255, 207, 0, 1);
@git-infoColor: rgba(255, 207, 0, 1);
@git-successColor: rgba(0, 250, 93, 1);
@git-warningColor: rgba(255, 147, 0, 1);
@git-errorColor: rgba(255, 38, 0, 1);
...
@editor-color: rgba(132, 200, 154, 1);
...
@selectedline-backgroundguttercolor: rgba(255, 213, 0, 1);
@cursor-style: pacman;
...
@punctuation-color: rgba(148, 82, 0, 1);
...
@regex-weight: normal;
@control-color: rgba(255, 147, 0, 1);
...
// @editor-backgroundcolor: rgba(33, 33, 33, 1);
