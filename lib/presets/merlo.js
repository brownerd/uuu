export const merloUI = `@text-color: rgba(139, 23, 93, 1);
@text-value: 10;
...
export const merloSyntax = `@editor-backgroundcolor: rgba(67, 18, 63, 1);
@editor-color: rgba(255, 207, 0, 1);
@gutter-backgroundcolor: rgba(67, 16, 64, 1);
@gutter-color: rgba(137, 23, 93, 1);
@gutter-punk: hellyeah;
@selectedline-backgroundcolor: rgba(34, 5, 39, 1);
@cursor-style: pacman;
