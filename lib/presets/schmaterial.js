...
export default {
  theme: {
    ui: `@text-color: rgba(170, 170, 170, 1);
@text-value: 0;
...
@settingsPage-border: false;`,
    syntax: `@editor-backgroundcolor: rgba(37, 49, 58, 1);
@editor-color: rgba(170, 170, 170, 1);
@gutter-backgroundcolor: rgba(37, 49, 58, 1);
@gutter-color: rgba(170, 170, 170, 1);
@gutter-value: 30;
@gutter-punk: hellyeah;
@selectedline-backgroundcolor: rgba(33, 42, 49, 1);
@selectedline-backgroundguttercolor: rgba(170, 170, 170, 1);
@cursor-style: pacman;
