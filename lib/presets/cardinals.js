...
export const cardinalsUI = `@text-color: rgba(50, 65, 92, 1);
@text-value: 0;
...
@settingsPage-border: true;`;

export const cardinalsSyntax = `@editor-backgroundcolor: rgba(220, 50, 47, 1);
@editor-color: rgba(50, 51, 51, 1);
@gutter-backgroundcolor: rgba(220, 50, 47, 1);
@gutter-color: rgba(50, 51, 51, 1);
@gutter-punk: hellyeah;
@selectedline-backgroundcolor: rgba(255, 205, 33, 1);
@indentguide-linecolor: rgba(255, 106, 95, 1);
@folded-codecolor: rgba(255, 205, 33, 1);
@cursor-style: pacman;
@cursor-color: rgba(255, 251, 0, 1);
@cursor-shadow: rgba(51, 51, 51, 1);
@bracketmatcher-background: rgba(255, 205, 33, 1);
@comment-color: rgba(255, 106, 95, 1);
@comment-fontstyle: normal;
@punctuation-color: rgba(50, 51, 51, 1);
@punctuation-weight: bold;
@quotationmark-color: rgba(51, 51, 51, 1);
@quotationmark-weight: bold;
@string-color: rgba(219, 179, 71, 1);
@string-fontstyle: italic;
@string-weight: normal;
@operator-color: rgba(218, 180, 71, 1);
...
@propertyname-color: rgba(118, 214, 255, 1);
...
@class-weight: normal;
@control-color: rgba(118, 214, 255, 1);
...
@gitgutter-lineremovedcolor: rgba(113, 10, 3, 1);`;
