...
export default {
  theme: {
    ui: `@text-color: rgba(18, 18, 18, 1);
@text-value: 0;
@heading-color: rgba(237, 237, 245, 1);
@heading-value: 0;
@background-color: rgba(156, 157, 162, 1);
@background-value: 0;
@background-navvalue: -30;
@button-color: rgba(250, 62, 45, 1);
@button-value: 0;
@button-textcolor: text;
@border-value: -25;
@border-radius: 2;
@findAndReplace-borderHighLightColor: rgba(255, 255, 255, 1);
@findAndReplace-borderHighLightColorCurrent: rgba(249, 61, 44, 1);
...
@settingsPage-border: false;`,
    syntax: `@editor-backgroundcolor: rgba(156, 157, 162, 1);
@editor-color: rgba(18, 18, 18, 1);
@gutter-backgroundcolor: rgba(156, 157, 162, 1);
@gutter-color: rgba(18, 18, 18, 1);
@gutter-value: 0;
@gutter-punk: hellyeah;
@selectedline-backgroundcolor: rgba(192, 192, 192, 1);
@selectedline-backgroundguttercolor: rgba(255, 57, 8, 1);
@cursor-style: pacman;
@cursor-color: rgba(255, 213, 0, 1);
@cursor-shadow: rgba(51, 51, 51, 1);
@indentguide-linecolor: rgba(137, 138, 144, 1);
@indentguide-value: 0;
@folded-codecolor: rgba(255, 255, 255, 1);
@bracketmatcher-backgroundcolor: rgba(255, 255, 255, 1);
@comment-color: rgba(121, 121, 121, 1);
@comment-fontstyle: normal;
@comment-value: 0;
@selector-color: rgba(18, 18, 18, 1);
@selector-fontstyle: normal;
@pseudo-color: rgba(148, 17, 0, 1);
...
@type-weight: bold;
@identifier-color: rgba(18, 18, 18, 1);
