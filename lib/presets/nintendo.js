export superNintendoUI = `@text-color: rgba(86, 85, 90, 1);
@text-value: 0;
...
export superNintendoSyntax = `@editor-backgroundcolor: rgba(214, 214, 214, 1);
...
@class-color: rgba(129, 120, 1, 1);
@class-fontstyle: normal;
@class-weight: normal;
@control-color: rgba(0, 143, 0, 1);
