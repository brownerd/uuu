...
export conts donetellolUI = `@text-color: rgba(75, 85, 18, 1);
@text-value: 0;
...
export conts donetelloSyntax = `@editor-backgroundcolor: rgba(151, 166, 52, 1);
@editor-color: rgba(75, 85, 9, 1);
@gutter-backgroundcolor: rgba(152, 166, 62, 1);
@gutter-color: rgba(75, 85, 0, 1);
@gutter-punk: hellyeah;
@selectedline-backgroundcolor: rgba(255, 205, 33, 1);
@indentguide-linecolor: rgba(170, 183, 79, 1);
