...
export const bosonUI = `@text-color: rgba(51, 51, 51, 1);
@text-value: 0;
...
export const bosonSyntax = `@editor-backgroundcolor: rgba(255, 255, 255, 1);
@editor-color: rgba(51, 51, 51, 1);
@comment-color: rgba(214, 214, 214, 1);
@comment-fontstyle: normal;
@cursor-style: bar;
@cursor-color: rgba(255, 64, 255, 1);
...
@selectedline-backgroundcolor: rgba(169, 169, 169, 1);
