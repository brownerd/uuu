...
export default {
  ...
  activate() {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      // Run Presets
      'uuu:runpreset1': () => runpreset(schmaterial),
      'uuu:runpreset2': () => runpreset(strangerthings),
      'uuu:runpreset3': () => runpreset(superNES),
      'uuu:runpreset4': () => runpreset(crockford),
      'uuu:runpreset5': () => runpreset(airmax95),
      'uuu:runpreset6': () => runpreset(miamivice),
      'uuu:runpreset7': () => runpreset(princessPeach),
      'uuu:runpreset8': () => runpreset(brownerd),
